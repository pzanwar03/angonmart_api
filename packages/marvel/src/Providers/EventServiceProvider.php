...
use Marvel\Listeners\Refund\SendRefundUpdateListener;
...
use Marvel\Listeners\SendRefundRequestedListener;
...
class EventServiceProvider extends ServiceProvider
{
    ...
    protected $listen = [
        ...
        RefundRequested::class => [
            SendRefundRequestedListener::class
        ],
        RefundUpdate::class => [
            SendRefundUpdateListener::class
        ],
